  ...
  return (
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4" onClick={onClose}>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="create-debate-dialog-title"
      >
        <div className="flex items-center justify-between">
          <h2 id="create-debate-dialog-title" className="text-lg font-bold">New Debate</h2>
          <button onClick={onClose} aria-label="Close dialog" className="text-[var(--text-muted)] hover:text-[var(--text-primary)] transition-colors">
