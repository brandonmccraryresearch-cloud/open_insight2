...
**Scientific Computing Tools** (search_arxiv / symbolic_algebra / compute_physics / lookup_pdg / simulate_quantum):
...
- Use symbolic_algebra for symbolic math with SymPy — simplify, factor, differentiate, integrate, solve equations, series expansion. Great for verifying algebraic identities or deriving results.
...
- Use lookup_pdg to look up particle physics data from the Particle Data Group — particle masses, lifetimes, decay modes, branching ratios, coupling constants.
- Use simulate_quantum to simulate quantum systems — time evolution, entanglement entropy, measurement probabilities, quantum gate operations, many-body physics.
