    ...
    <div className="page-enter p-6 max-w-6xl mx-auto space-y-8">
      ...
      <section className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          { label: "Formal Proofs", value: String(stats.lean4Proofs), color: "var(--accent-indigo)", icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4", href: "/formalism", tooltip: "Tier 3 proofs verified via Lean 4 theorem prover" },
        ].map((stat) => (
